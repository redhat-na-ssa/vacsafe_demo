  ...
  return {
    module: {
      rules: [
        ...
        {
          test: /\.svg$/,
          // only process SVG modules with this loader if they live under a 'Assets' directory
        ...
        {
          test: /\.svg$/,
          // only process SVG modules with this loader when they don't live under a 'Assets',

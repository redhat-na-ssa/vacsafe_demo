...
// @Entity
// @Table(
//     name = "cs_hr_exception_table",
//     indexes = {
//         @Index(name = "idx_cs_hr_exception_employee_id", columnList = "employee_id", unique = true)
//     }
// )
// public class HrVaccineExceptionTable implements Serializable {

//     static final long serialVersionUID = 1L;

//     @Id
//     @GeneratedValue(generator = "HR_EXCEPTION_TABLE_ID_GENERATOR", strategy = javax.persistence.GenerationType.AUTO)
//     @SequenceGenerator(name = "HR_EXCEPTION_TABLE_ID_GENERATOR", sequenceName = "HR_EXCEPTION_TABLE_ID_SEQ", allocationSize = 1)
//     protected Long id;
...
//         return "HrVaccineExceptionTable [agencyCode=" + agencyCode + ", agencyName=" + agencyName + ", employeeId="
